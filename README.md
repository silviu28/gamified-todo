# Gamified To Do App
#### <a href="https://www.youtube.com/watch?v=f3aIP9zEbpY">Video Demo</a>

## Description

> The following contains informative text marked in *italic*.
...
Add a personal touch to your progress using themes. Create a personal profile and share it to your friends.

## Technologies

This app has been created using <a href="https://reactnative.dev/">React Native</a>, with the help of <a href="https://expo.dev/">Expo</a>. *React is a popular JavaScript library used for the web in order to make Single-Page Applications (or SPAs for short). Its smaller brother, React Native, brings all the nice things of React to native development, allowing people that might've had experience with React to port it over to platform-independent apps through the so-called "JavaScript bridge", which interprets the code to their platform-specific counterpart. This allows us to have only one codebase to manage. Unfortuntely, React Native by itself is quite rough around the edges, as it is pretty tough to integrate every platform's feature set, this would require a lot of code branching depending on the platform. Luckily, this is where Expo comes in, which brings in a lot of useful tools alongside many utilities that have this platform-specific code already written.
